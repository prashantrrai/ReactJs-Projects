...
const Login = () => {
  ...
  const loginSubmit = (e) => {
    ...
    if (email==="admin@prashantrai.com" && password==="Q12345678"){
      //do routing 
      navigate('/myusers');
      ...
      <section class="text-gray-400 bg-gray-900 body-font" >
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          ...
          <div class="lg:w-2/6 md:w-1/2 bg-gray-800 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <button class="text-white bg-violet-600 border-0 py-2 px-8 focus:outline-none hover:bg-violet-700 rounded text-lg" type='submit' onClick={loginSubmit}>Submit</button>
