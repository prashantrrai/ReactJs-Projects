    ...
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <a className="flex title-font font-medium items-center text-white mb-4 hover: md:mb-0" href="/">
          ...
          <svg width="50" height="50" viewBox="-32.583735 -32.583735 416.84217 365.16747" >
            <g>
              <path fill="#7c3aed" stroke="black" d="M 0 300 l 100 -300 l 200 0 c 58.86234 0 60 50 40 110 c -19.996015 59.973009 -39.996015 89.973009 -109.942068 89.997311 l -100.057931 0.002688 l -30 100 l -100 0 "/>
